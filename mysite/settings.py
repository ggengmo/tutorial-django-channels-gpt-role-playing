...
SECRET_KEY = "django-insecure-__*&nykjacaa&p*rq0uwjnzrg5tk0j$zt(=56vszb5932db4$u"
...
LANGUAGE_CODE = env.str("LANGUAGE_CODE", default="ko-kr") # 디폴트 언어 코드를 한국어로 지정합니다.
